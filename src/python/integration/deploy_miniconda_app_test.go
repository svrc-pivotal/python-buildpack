...
var _ = Describe("CF Python Buildpack", func() {
	...
	Context("an app that uses miniconda and specifies python 2 in runtime.txt but python3 in the environment.yml", func() {
		...
		It("deploys", func() {
			...
			Expect(app.Stdout.String()).To(ContainSubstring("**WARNING** you have specified the version of Python runtime both in 'runtime.txt' and 'environment.yml'. You should remove one of the two versions"))
		})
